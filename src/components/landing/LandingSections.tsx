    ...
    <section id="pricing" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 border-t border-border">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          viewport={{ once: true, margin: "-50px" }}
        >
          <PricingCard i={0} name="Core" price="$69" originalPrice="$100" period="/month" desc="1 creator · 5 team members" discountBadge="Save 31%" features={["Unified employee management", "Basic shift scheduling", "Creator profiles + onboarding", "Task management dashboard", "Basic performance tracking", "Audience CRM", "Secure Access", "50 GB Content Vault"]} ctaLabel="Get Started" highlight={false} />
