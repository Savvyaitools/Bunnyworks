...
export default function InternalMessages() {
  ...
  const showList = isMobile ? !mobileShowChat : true;
        ...
        {showList && (
          <div className={`${isMobile ? 'w-full' : 'w-80'} border-r border-border flex flex-col`}>
            <div className="p-3 md:p-4 border-b border-border">
              <h2 className="text-base md:text-lg font-semibold text-foreground mb-2 md:mb-3 flex items-center gap-2">
                  ...
                  {filteredMembers.map((member) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center gap-3 p-3 rounded-lg transition-colors text-left min-h-[44px] ${
                          isSelected
                ...
                <div className="p-3 md:p-4 border-b border-border flex items-center justify-between">
                  <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2">
                        <p className="font-medium text-foreground text-sm md:text-base truncate">{selectedMember.name}</p>
                        <Badge 
