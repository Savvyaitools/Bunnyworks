  ...
  return <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 animate-fade-in relative z-10">
        ...
        {mode === "signup" && <div className="grid grid-cols-2 gap-4">
            <button type="button" onClick={() => setUserType("agency")} className={cn("glass-card p-4 text-center transition-all duration-200", userType === "agency" ? "border-primary bg-primary/10" : "hover:border-muted-foreground/50")}>
            ...
            <button type="button" onClick={() => setUserType("creator")} className={cn("glass-card p-4 text-center transition-all duration-200", userType === "creator" ? "border-accent bg-accent/10" : "hover:border-muted-foreground/50")}>
        ...
        <form onSubmit={handleSubmit} className="glass-card p-6 space-y-4">
          ...
          })} required={mode === "signup"} className="bg-muted/50 border-border focus:border-primary" />
            </div>}
          ...
          })} required className="bg-muted/50 border-border focus:border-primary" />
          </div>
          ...
          })} required minLength={6} className="bg-muted/50 border-border focus:border-primary" />
          </div>
        ...
        <div className="text-center">
          <p className="text-muted-foreground">
            ...
            <button type="button" onClick={() => setMode(mode === "signin" ? "signup" : "signin")} className="ml-2 text-primary hover:underline font-medium">
